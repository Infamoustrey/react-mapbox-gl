...
var ZoomControl = (function (_super) {
    ...
    ZoomControl.prototype.render = function () {
        ...
        var plusStyle = __assign(__assign(__assign({}, buttonStyle), buttonStylePlus), (hover === PLUS ? buttonStyleHovered : {}));
        var minusStyle = __assign(__assign(__assign({}, buttonStyle), buttonStyleMinus), (hover === MINUS ? buttonStyleHovered : {}));
        return (React.createElement("div", { className: className, tabIndex: tabIndex, style: __assign(__assign(__assign({}, containerStyle), positions[position]), style) },
